package com.juyoufuli.service.weixin.util;

import com.juyoufuli.service.weixin.pojo.AccessToken;
...
public class WeiXinUtil {
   ...
   /**
	...
	public static Map<String, Object> getWxConfig(HttpServletRequest request) {
		...
		String jsapiTicket =getJsapiTicket(accessToken);// 必填，生成签名的H5应用调用企业微信JS接口的临时票据
