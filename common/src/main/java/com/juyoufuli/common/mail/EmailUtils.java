package com.juyoufuli.common.mail;

import com.juyoufuli.common.io.PropertiesLoader;
...
public class EmailUtils {
	...
	public static boolean sendEmail(String toAddress, String subject, String content) {
		PropertiesLoader loader = new PropertiesLoader("settings.properties");
		String fromAddress = loader.getProperty("email.fromAddress");
		String fromPassword = loader.getProperty("email.fromPassword");
		String fromHostName = loader.getProperty("email.fromHostName");
		String sslOnConnect = loader.getProperty("email.sslOnConnect", "false");
		String sslSmtpPort = loader.getProperty("email.sslSmtpPort");
