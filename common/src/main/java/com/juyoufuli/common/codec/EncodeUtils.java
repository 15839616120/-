package com.juyoufuli.common.codec;
...
import com.juyoufuli.common.lang.ExceptionUtils;
...
//	}
	 ...
	 * unicode 解码.
	 */
	public static String unescapeJava(String javaEscaped) {
		return StringEscapeUtils.unescapeJava(javaEscaped);
	}
